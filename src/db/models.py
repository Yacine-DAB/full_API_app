...
class User(SQLModel, table=True):
     ...
     password_hash: str = Field(
          sa_column=Column(sa_column=Column(pg.VARCHAR, nullable=False, exclude=True))
     )
...
class Review(SQLModel, table=True):
     ...
     user_uid: Optional[uuid.UUID] = Field(default=None, foreign_key='users_uid')
     book_uid: Optional[uuid.UUID] = Field(default=None, foreign_key='books_uid')
     created_at: datetime = Field(sa_column=Column(pg.TIMESTAMP, default=datetime.now))
     updated_at: datetime = Field(sa_column=Column(pg.TIMESTAMP, default=datetime.now))
     user: Optional[User] = Relationship(
