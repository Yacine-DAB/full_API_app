...
from .schema import Book, BookCreateModel, BookDetailModel, BookUpdateModel
...
async def create_book(
     ...
     session: AsyncSession = Depends(get_session),
     token_datails: dict = Depends(access_token_bearer),
) -> dict:
     user_id = token_datails.get('user')['user_uid']
